...
export function Login({ onLoginSuccess }: LoginProps) {
  ...
  // Función para iniciar OAuth (solo Google)
      ...
      <div className="bg-gradient-to-br from-white/5 via-white/10 to-white/5 backdrop-blur-3xl rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] w-full max-w-md p-10 border border-white/10 relative overflow-hidden">
        ...
        <div className="space-y-3 mb-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-5 py-3.5 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-white/20 rounded-xl hover:from-emerald-500/30 hover:to-teal-500/30 hover:border-white/40 hover:shadow-[0_10px_40px_rgba(16,185,129,0.3)] transition-all duration-300 font-semibold text-white shadow-lg backdrop-blur-md relative overflow-hidden group"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/0 via-teal-500/10 to-emerald-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
